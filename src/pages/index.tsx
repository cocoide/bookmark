      ...
      <div className='pb-12 text-center md:pb-16'>
        ...
        <div className='mx-auto max-w-3xl'>
          ...
          <div className='flexjustify-center mt-5'>
            <div className='mt-3'>
              <Link href='/articles'>
                <div className='group inline-flex items-center justify-center overflow-hidden rounded-lg bg-gradient-to-br from-purple-600 to-blue-500 p-0.5 font-medium text-gray-900 hover:text-white focus:ring-4 focus:ring-blue-300 group-hover:from-purple-600 group-hover:to-blue-500 dark:text-white dark:focus:ring-blue-800'>
